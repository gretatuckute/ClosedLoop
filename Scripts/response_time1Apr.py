...
for count, idx in enumerate(lureIdx):
    idxn=idx-1
    lure_RT_add[count] = responseTimes1[idxn] #This is the RT right before the lure. Remember to draw from the RT list with all vals
...
# New approach, before CR mean 0.63 og before FR mean 0.38


#%% First attempt at RTaroundLure function
